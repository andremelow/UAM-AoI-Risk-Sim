...
%  persistently bad-channel drones regardless of how high their R_u*h
%  score grows, causing unbounded AoI.  Failed transmissions leave AoI
%  high, which is the natural mechanism that keeps these drones in
%  contention.
